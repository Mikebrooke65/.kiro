...
5. WHEN the Success_Screen renders the matching-address welcome, THE Success_Screen SHALL display guidance text that states all of the following: that on the Team_Page the registrant will see teams they can manage, that the registrant can add players, and that the registrant can promote one additional player to Manager up to a maximum of two Managers per team.
